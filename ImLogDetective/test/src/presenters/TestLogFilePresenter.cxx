...
protected:
    ...
    const std::vector<ImLogDetective::LogLine> dummyLogData;
...
TestLogFilePresenter::TestLogFilePresenter() :
    ...
    filePath{"/fake/path"},
    dummyLogData {
        ImLogDetective::LogLine{"11:51:45,518 - DEBUG - Foo.Bar - foo bar", ImLogDetective::LogLevel::Debug},
        ImLogDetective::LogLine{"11:51:45,527 - INFO - Lorem.Ipsum - lorem ipsum", ImLogDetective::LogLevel::Info},
        ImLogDetective::LogLine{"11:51:45,718 - WARNING - Excepteur.Sint - Excepteur sint", ImLogDetective::LogLevel::Warning},
        ImLogDetective::LogLine{"11:51:46,318 - ERROR - Nemo.Enim - Nemo enim", ImLogDetective::LogLevel::Error}
    }
{
}
