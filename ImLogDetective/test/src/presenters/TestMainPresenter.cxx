...
{
    auto inputScaleFactor = ImLogDetective::Scaling::ScaleFactorLowerBound;
    ...
    expectedFolderSelectionWindowPopupSize.x *= LayoutBounds::SmallPopupWindowRelativeToMain_X;
    expectedFolderSelectionWindowPopupSize.y *= LayoutBounds::SmallPopupWindowRelativeToMain_Y;

    expectedCopyLogsWindowPopupSize = windowSize;
    expectedCopyLogsWindowPopupSize.x *= LayoutBounds::LargePopupWindowRelativeToMain_X;
    expectedCopyLogsWindowPopupSize.y *= LayoutBounds::LargePopupWindowRelativeToMain_Y;
}
...
ScopedImGuiWindowMock* TestMainPresenter::checkMainWindowAndMenuBarCreation(const float inputScaleFactor)
{
    ...
    EXPECT_CALL(mainViewPortMock, setViewportScale(::testing::Eq(inputScaleFactor)));
    ...
    const ImVec2& mainWindowPos)
{
    ...
    EXPECT_CALL(fileListPresenterMock, update(::testing::Eq(testFolderPath), false));
